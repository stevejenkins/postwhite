...
# Options
To make managing whitelisted hosts easier, Postwhite splits trusted mailers into five categories: **webmailers**, **ecommerce**, **social networks**, **bulk senders**, and **other/miscellaneous** hosts. Trusted webmailers, for example, are listed in the webmail_hosts option, separated 
by a single space:
